...
const paths = {
  ...
  'operating-advisor-response': { '1.2.0': 'schemas/v1.2.0/operating-advisor-response.schema.json' },
  'operating-adapter-handoff': { '1.2.0': 'schemas/v1.2.0/operating-adapter-handoff.schema.json' },
