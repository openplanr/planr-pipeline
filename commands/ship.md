---
description: DEPRECATED — this plugin was renamed to planr-pipeline. Install the new plugin and use /planr-pipeline:ship instead.
argument-hint: <feature-name>
---

# /openplanr-pipeline:ship — DEPRECATED
...
The CLI you run daily is `planr`. Having to type `/openplanr-pipeline:ship` for slash commands created friction. The rename aligns the brand: `planr` (CLI) ↔ `planr-pipeline` (the executor it pairs with).
...
**STOP.** Do not run any of the original DEV Phase logic. Print this message only.
