...
- **R3** — Roles using `Sonnet 4.6` include analysis/decomposition and **entity-scaffold-agent** (structured Step 0.2 scaffold). Roles using `Opus 4.7` are DEV codegen (**frontend-agent**, **backend-agent** Tech tasks). On Codex, use the model picker to match.
