...
After 3 failures: STOP. Write `…/tasks/T-<TASK_ID>-error-report.md`
...
| Compile error after 3 iterations | Stop, write `…/tasks/T-<TASK_ID>-error-report.md` per `${CLAUDE_PLUGIN_ROOT}/templates/error-report.md` schema |
