...
> Per-capability parity across the three first-class runtime adapters. Updated for planr-pipeline v0.35.0.
...
*OpenPlanr Protocol v1.0 artifacts + v1.1/v1.2/v1.3 ecosystem contracts - compatibility matrix for planr-pipeline v0.35.0.*
