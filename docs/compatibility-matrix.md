...
> Per-capability parity across the three first-class runtime adapters. Updated for planr-pipeline v0.24.10.
...
*OpenPlanr Protocol v1.0.0 - compatibility matrix for planr-pipeline v0.24.10.*
