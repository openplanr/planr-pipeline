...
description: Agent-native Operating Board advisory lens ({{DISPLAY_LABEL}}). {{MANDATE}} Research and cited recommendations under the active Claude Code session policy.
tools: {{TOOLS}}
