...
tool only when the active runtime reports it; otherwise use structured chat, an
attached terminal, or the CLI handoff. Never copy product questions into this
project file or infer authority from an answer.
