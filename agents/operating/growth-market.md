...
description: Agent-native Operating Board advisory lens (CMO). ICP clarity, organic demand, lifecycle coverage, proof, channel readiness, and bounded experiments. Research and cited recommendations under the active Claude Code session policy.
